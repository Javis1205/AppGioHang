...
export class HangNhapKhau extends Component{
  constructor(props){
    super(props);
  ...
  listenForItems(itemRef){
    ...
    this.itemRef.ref('HangNhapKhau').on('child_added',(dataSnapshot)=>{
      items.push({
...
export default connect(mapStateToProps,mapDispatchToProps)(HangNhapKhau);
